 ...
 * @return
 ...
 <li>Command State Error       : RFCommonResult_OTHER_CMD_RUNNING_ERROR = -4</li>
 <li>Mode Error                : RFResult_MODE_ERROR = -6</li>
 <li>Battery Error             : RFResult_LOW_BATTERY = -12</li>
 <li> HotSwap Mode Error       : RFCommonResult_ERROR_HOTSWAP_STATE = -37
 </ul>
...
/*!
 * @brief Performs the inventory operation
 * @param epc The epc value to locate.
 * @return
 <ul>
 <li>Success                   : RFResult_SUCCESS = 0</li>
 <li>Enabled Error             : RFCommonResult_BLUETOOTH_NOT_ENABLED = -15</li>
 ...
 */
-(int)RF_PerformInventoryForLocating:(NSString*)epc;
/*!
 ...
 * @return
 <ul>
 <li>Success                         : RFResult_SUCCESS = 0</li>
 <li> BT Enabled Error               : RFCommonResult_BLUETOOTH_NOT_ENABLED = -15</li>
 <li>Connected Error                 : SDCommonResult_SD_NOT_CONNECTED = -5</li>
 ...
 * @return
 ...
 <li>Condition Error           : RFResult_READER_OR_SERIAL_STATUS_ERROR = -7</li>
 <li>Command State Error       : RFCommonResult_OTHER_CMD_RUNNING_ERROR = -4</li>
 <li>HotSwap Error             : RFCommonResult_ERROR_HOTSWAP_STATE = -37
 </ul>
 */
...
/*!
 * @brief Sets the selection flag.<br>Specifies the state of selected (SL) flag for tags that will have operation applied to them <br> Only operate when the selection option enable state.
 * @param       RFSelectionFlag (ALL(1) ,DEASSERTED(2) ,ASSERTED(3 ,default)
 * @return
 <ul>
 <li>Success                   : RFResult_SUCCESS = 0</li>
 <li>Range Error               : SDConstsBT_RFResult_ARGUMENT_ERROR = -3
 ...
 */
-(int) RF_SetselectionFlag:(int) RFSelectionFlag;

/*!
 * @brief Gets the selection flag.
 * @return
 <ul>
 <li>Success                   : Value of the selection Flag (ALL(1),DEASSERTED(2),ASSERTED(3,default)
 </li>
 <li>Range Error               : SDConstsBT_RFResult_ARGUMENT_ERROR = -3
 <li>Enabled Error             : RFCommonResult_BLUETOOTH_NOT_ENABLED = -15</li>
 <li>Connected Error           : SDCommonResult_SD_NOT_CONNECTED = -5</li>
...
/*!
 * @brief Sets the Max power Limit (MaxPower) value of the RFID radio module.
 * @param       MaxPower  (50 ~ 300) : default 0 OFF
 * @return
 <ul>
...
-(int)RF_SetRadioMAxPowerLimit:(int)MaxPower;
 ...
 * @return
 ...
 <li>Condition Error           : RFResult_READER_OR_SERIAL_STATUS_ERROR = -7</li>
 <li>Command State Error       : RFCommonResult_OTHER_CMD_RUNNING_ERROR = -4</li>
 <li>Argument Error            : SDConstsBT_RFResult_ARGUMENT_ERROR = -3</li>
 <li>HotSwap Error             : RFCommonResult_ERROR_HOTSWAP_STATE = -37
 </ul>
 */
...
/*!
 * @brief Gets the Max Power Limit (MaxPower) value of the RFID radio module
 * @return
 <ul>
 <li>Success                   : Value of the MaxPower (1 ~300)
 <li>Enabled Error             : RFCommonResult_BLUETOOTH_NOT_ENABLED = -15</li>
 <li>Connected Error           : SDCommonResult_SD_NOT_CONNECTED = -5</li>
 <li>Block State Error         : RFCommonResult_OTHER_CMD_RUNNING_ERROR = -4</li>
 <li>Condition Error           : RFResult_READER_OR_SERIAL_STATUS_ERROR = -7</li>
 ...
 * @return
 ...
 <li>Condition Error           : RFResult_READER_OR_SERIAL_STATUS_ERROR = -7</li>
 <li>Command State Error       : RFCommonResult_OTHER_CMD_RUNNING_ERROR = -4</li>
 <li>HotSwap Error             : RFCommonResult_ERROR_HOTSWAP_STATE = -37</li>
 <li>HotSwap Error             : RFCommonResult_ERROR_HOTSWAP_STATE = -37
 </ul>
 */
 ...
 * @param       RFRegion    Import or sets-up history of country-by-country frequency(0 ~ 30)
 ...
 <br>THAILAND = 25, URUGUAY = 26, VENEZUELA = 27, VIETNAM = 28, RUSSIA = 29, ALGERIA = 30, EGYPT = 31, CHILE = 32
 * @return
 <ul>
 <li>Success                   : RFResult_SUCCESS = 0
 <li>Enabled Error             : RFCommonResult_BLUETOOTH_NOT_ENABLED = -15</li>
 ...
 * @return
 <ul>
  <li>Success                   : Value of the Region(KOREA(0) ~ CHILE(32), UNKNOWN(-1))
 <li>Enabled Error             : RFCommonResult_BLUETOOTH_NOT_ENABLED = -15</li>
 <li>Connected Error           : SDCommonResult_SD_NOT_CONNECTED = -5</li>
 <li>Block State Error         : RFCommonResult_OTHER_CMD_RUNNING_ERROR = -4</li>
 <li>Condition Error           : RFResult_READER_OR_SERIAL_STATUS_ERROR = -7</li>
 ...
 * @return
 ...
 <li>Condition Error           : RFResult_READER_OR_SERIAL_STATUS_ERROR = -7</li>
 <li>Command State Error       : RFCommonResult_OTHER_CMD_RUNNING_ERROR = -4
 <li>Not Supported Error       : RFCommonResult_NOT_SUPPORTED_API = -36</li>
 <li>HotSwap Error             : RFCommonResult_ERROR_HOTSWAP_STATE = -37
 </ul>
 */
 ...
 * @return
 ...
 <li>Low battery               : RFResult_LOW_BATTERY = -12</li>
 <li>HotSwap Error             : RFCommonResult_ERROR_HOTSWAP_STATE = -37
 </ul>
 ...
 * @return
 ...
 <li>Charge Error              : SDCommonResult_CHARGING_STATE_ERROR = -14</li>
 <li>HotSwap Error             : RFCommonResult_ERROR_HOTSWAP_STATE = -37
 </ul>
 */
...
/*!
 * @brief Updates firmware of RFID radio module
 <BR/>(In case of this API, Run time during about 90 seconds is required. It sends related callback message(UPDATE_RF_FW_START(23) -> UPDATE_RF_FW(24) -> UPDATE_RF_FW_END(25)) at the beginning and the end.)
 * @param		filepath		File path for RFID firmware update
 * @return
 <ul>
 <li>Success                   : RFRESULT_SUCCESS = 0
 <li/>Enabled Error            : RFCommonResult_BLUETOOTH_NOT_ENABLED = -15
 ...
 */
-(int)RF_UpdateRFIDFirmware:(NSString *) filepath;

//@Deprecated
// Not Support API
/*!
 * @brief Updates the boot loader of the SLED <BR/>Do update unconditionally
 <BR/>(In case of this API, Run time during about 90 seconds is required. It sends related callback message(UPDATE_SD_FW_START(48) -> UPDATE_SD_FW(49) -> UPDATE_SD_FW_END(50)) at the beginning and the end.)
 * @param       filepath    File path for SLED firmware update
 * @return
 <ul>
 Success : ConstantsBT.SDResult.SUCCESS = 0
 <li>Success                   : RFRESULT_SUCCESS = 0
 <li/>Enabled Error            : RFCommonResult_BLUETOOTH_NOT_ENABLED = -15
 <li>Block State Error         : RFCommonResult_OTHER_CMD_RUNNING_ERROR = -4
 <li>Connected Error           : SDCommonResult_SD_NOT_CONNECTED = -5
 ...
 */
-(int) SD_UpdateSLEDBootloader:(NSString*) filepath;

/*!
 * @brief Updates the firmware of the SLED smartly
 <BR/>Do update If new firmware binary is newest than current version
 <BR/>(In case of this API, Run time during about 90 seconds is required. It sends related callback message(UPDATE_SD_FW_START(48) -> UPDATE_SD_FW(49) -> UPDATE_SD_FW_END(50)) at the beginning and the end.)
 * @param       filepath    File path for SLED firmware update
 * @return
 <ul>
 ...
 */
-(int) SD_SmartUpdateSLEDFirmware:(NSString *)filepath;
/*!
 * @brief Gets the autoreconnection state of the SLED
 * @return 
 <ul>
 <li>Success                   : Value of the Auto reconnection state(Off(0), On(1))
 <li>Enabled Error             : RFCommonResult_BLUETOOTH_NOT_ENABLED = -15</li>
 <li>Connected Error           : SDCommonResult_SD_NOT_CONNECTED = -5</li>
 <li>Block State Error         : RFCommonResult_OTHER_CMD_RUNNING_ERROR = -4</li>
 <li>Condition Error           : RFResult_READER_OR_SERIAL_STATUS_ERROR = -7</li>
 ...
 */
-(int)SD_GetAutoReConnectionEstablishState;
/*!
 * @brief Sets the AutoReconnectionEsblish state of the SLED
 <BR>If this feature is enabled ,RFR reader will store the last connected device and connect automatically when its available.
 <BR>Default value is disabled.
 * @param      SDAutoReConnectState (Enable : 1, Disable : 0)
 * @return
 <ul>
 <li>Success                   : RFResult_SUCCESS = 0
 <li>Range Error               : SDConstsBT_RFResult_ARGUMENT_ERROR = -3
 ...
 */
-(int)SD_SetAutoReConnectionEstablish:(int)SDAutoReConnectState;
/*!
 * @brief Gets the timeout value of access apis(ref. IRfidAccess interface) for the RFID radio module
 * @return      Success : Value of the AccessTimeout(MIN_ACCESS_TIMEOUT(100) ~ MAX_ACCESS_TIMEOUT(10000))
 <ul>
 <li>Enabled Error : SDConsts.RFAccessTimeout.BLUETOOTH_NOT_ENABLED = -15
 <li>Connected Error : SDConsts.RFAccessTimeout.SD_NOT_CONNECTED = -5
 <li>Block State Error : SDConsts.RFAccessTimeout.OTHER_CMD_RUNNING_ERROR = -4
 <li>Condition Error : SDConsts.RFAccessTimeout.READER_OR_COM_INTERFACE_STATUS_ERROR = -7
 <li>Hotswap Error : SDConsts.RFAccessTimeout.ERROR_HOTSWAP_STATE = -37
 <li>* Can receive other error constant of "RFAccessTimeout" class.
 </ul>
 */
-(int) RF_GetAccessTimeout;

/*!
 * @brief Sets the timeout value of access apis(ref. IRfidAccess interface) for the RFID radio module
* @param       millisec    Timeout value(millisecond) of access apis(100 ~ 10000 : 3000(default))
* @return      Success : Constants.RFResult.SUCCESS = 0
 <ul>
<li>Enabled Error : SDConsts.RFResult.BLUETOOTH_NOT_ENABLED = -15
<li>Connected Error : SDConsts.RFResult.SD_NOT_CONNECTED = -5
<li>Block State Error : SDConsts.RFResult.OTHER_CMD_RUNNING_ERROR = -4
<li>Condition Error : SDConsts.RFResult.READER_OR_COM_INTERFACE_STATUS_ERROR = -7
<li>Hotswap Error : SDConsts.RFResult.ERROR_HOTSWAP_STATE = -37
<li>* Can receive other error constant of "RFResult" class.
 </ul>
*/
-(int) RF_SetAccessTimeout:(int) millisec ;

/*!
 *@brief deprecated
 */
-(int) SB_GetAllDefaultParamValues ;

/*!
 *@brief deprecated
 */
-(int)SB_GetAllParamValues;

/*!
 *@brief deprecated Sets the parameters to their default values.
 */
-(int) SB_SetParamDefault;

/*!
 *@brief deprecated Not Use API Commands imager into operational modes.
 */
-(int) SB_SetImagerMode:(int) ImagerMode;

/*!
 *@brief deprecated Not Use API Enables/ Disables all code types.
 */
-(int) SB_SetAllBarcodeType:(BOOL) enableAll;

/*!
 *@brief deprecated Not Use API Requests commands which decoder will perform.
 */
-(int) SB_GetCapabilities;

/*!
 *@brief deprecated Not Use API Transmits stored decode data.
 */
-(int) SB_GetBatch;

/*!
 *@brief deprecated Not Use API Tells the decoder to eliminate all packets in its transmission queue.
 */
-(int) SB_FlushQueue;


/*!
 *@brief deprecated Not Use API Terminates MacroPDF sequence and transmits captured segments.
 */
-(int) SB_FlushMacroPdf;

/*!
 *@brief deprecated Not Use API Terminates MacroPDF sequence and discards all captured segments.
 */
-(int) SB_AbortMacroPdf;

/*!
 *@brief deprecated Not Use API RSM command to read/set some scanner attributes.
 */
-(int) SB_SetMGMT:(UInt8*)b bLength:(int)bLength;

/*!
 * @brief Gets the decoder's Revision value.
 * @return
 <ul>
 Success : Value of decoder's revision
 <li>Success                   : RFRESULT_SUCCESS = 0
 <li/>Enabled Error            : RFCommonResult_BLUETOOTH_NOT_ENABLED = -15
 <li>Block State Error         : RFCommonResult_OTHER_CMD_RUNNING_ERROR = -4
 <li>Connected Error           : SDCommonResult_SD_NOT_CONNECTED = -5
